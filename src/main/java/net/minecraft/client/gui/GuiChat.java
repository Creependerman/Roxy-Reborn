...
public class GuiChat extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        boolean hovering = RenderUtil.isHovering(width / 2f - 50, 20, 100, 20, mouseX, mouseY);
        ...
        FontManager.arial18.drawCenteredString("还原全部位置", width / 2f, 23 + FontManager.arial18.getMiddleOfBox(20), -1);
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        ...
        DragManager.draggables.values().forEach(dragging -> {
            if (dragging.getModule().isState() && !GuiChat.isDragging) {
