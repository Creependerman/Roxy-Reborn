...
public class HUD extends Module {
    ...
    private final BooleanSetting info = new BooleanSetting("Info", false);
    ...
    private final Dragging drag = Client.instance.createDrag(this,"targethud", 5, 10);
    ...
    public static void oninfo() {
        ...
        String uname = Client.instance.getUserName();
            ...
            animation.render(() -> {
                switch (targetMode.getMode()) {
                    case "Lovely": {
                        ...
                        drag.setWH((int) width, (int) height);
