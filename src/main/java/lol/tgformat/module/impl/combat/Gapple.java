...
public class Gapple extends Module {
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        String text = "Gapple...";
        FontManager.arial18.drawStringWithShadow(text, startX + 10 + 60 - FontManager.arial18.getStringWidth(text) / 2F, startY + 20, -1);
        ...
        RoundedUtil.drawRound(startX + 10, (float) (startY + 7.5), Math.min(target, 120.0f), 2.0f, 1f, HUD.color(1));
    }
}